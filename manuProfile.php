    ...
    <div class="glass-card p-6 rounded-xl mb-6">
      <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <h1 class="text-2xl font-bold text-[#4ade80] pl-2"><?php echo $userName; ?></h1>
          <p class="text-[#cbd5e1] text-lg pl-2">Manufacturer</p>
          
          <div class="flex flex-wrap gap-2 justify-center md:justify-start mt-2">
            <span class="bg-[#1e293b] px-3 py-1 rounded-full text-sm text-[#4ade80] border border-[#4ade80]">Manufacturer</span>
            <span class="bg-[#1e293b] px-3 py-1 rounded-full text-sm text-[#4ade80] border border-[#4ade80]">8 Devices Supplied</span>
            <span class="bg-[#1e293b] px-3 py-1 rounded-full text-sm text-[#4ade80] border border-[#4ade80]">3 Service Partnerships</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <form id="personalForm">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="md:col-span-2">
            ...
            <input type="text" value="<?php echo $userName; ?>" class="w-full p-3 rounded-lg bg-[#1e293b] border border-[#4ade80] text-white form-field focus:outline-none">
          </div>
          <div class="md:col-span-2">
            <label class="block text-[#cbd5e1] mb-2">Email</label>
            <input type="email" value="<?php echo $userEmail; ?>" class="w-full p-3 rounded-lg bg-[#1e293b] border border-[#4ade80] text-white form-field focus:outline-none">
          </div>
          <div>
